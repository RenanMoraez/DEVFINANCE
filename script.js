const Modal = {
     open(){
         //abrir modal
         //adicionar o nome da classe active ao modal
 ...
 */
 ...
 const Storage = {
    get(){
        return JSON.parse(localStorage.getItem("dev.fenances:transactions")) || []
    },
    set(transactions){
        localStorage.setItem("dev.fenances:transactions", JSON.stringify(transactions))
    },
}
...
/**
 * Eu preciso pegar o objeto aqui no javascript e colocar no HTML
 */
